...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding:10px">
        <fieldset class="layui-elem-field layui-field-title"><legend>菜单</legend></fieldset>
        <div id="userMenuBar"> 
            <div class="layui-row">
...
<form class="layui-form" id="userForm" style="display:none;padding:10px 40px 10px 0px; ">
   <div class="layui-form-item">
       ...
       <div class="layui-input-block">
           <input type="text" name="isUse" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="note" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="loginName" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="mobile" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="loginPass" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="id" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
   <div class="layui-form-item">
       <label class="layui-form-label">字段名</label>
       <div class="layui-input-block">
           <input type="text" name="userName" required="required" lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input" />
       </div>
   </div>
  ...
  layui.use(['element', 'table', 'layer', 'form'], function () {
     ...
     var userTable = table.render({
        ...
        , cols: [[
           ...
           , {field: 'isUse', title: '字段名', width: 80, sort: true}
           , {field: 'note', title: '字段名', width: 80, sort: true}
           , {field: 'loginName', title: '字段名', width: 80, sort: true}
           , {field: 'mobile', title: '字段名', width: 80, sort: true}
           , {field: 'loginPass', title: '字段名', width: 80, sort: true}
           , {field: 'id', title: '字段名', width: 80, sort: true}
           , {field: 'userName', title: '字段名', width: 80, sort: true}
       ]]
       , height: 'full-240'
       , limit: 40
       , limits: [40]
     ...
     var active = {
        ...
        , modify: function () {
             ...
             if (data.length < 1){
                ...
                $.ajax({
                    type: 'get',
                    url: '/wbkj/user/info?id=' + id + '&sessionId='+new Date().getTime(),
     ...
     form.on('submit(userForm)', function (data) {
        var actionUrl = "/wbkj/user/" + $('#actionUrl').val();
        $.ajax({
            type: 'post',
