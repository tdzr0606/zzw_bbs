            ...
            <div class="layui-form layui-tab-content" style="padding: 20px 0;">
                <div class="layui-tab-item layui-show">
                    <div class="layui-form layui-form-pane">
                        <form method="post" lay-filter="registForm" id="registForm">
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 85px;height: 40px;">昵称</label>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 85px;height: 40px;">手机号</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="mobile" id="mobile" required lay-verify="phone"
                                           autocomplete="off" style="height: 40px;"
                                           class="layui-input">
                                </div>
                            </div>
                            ...
                            <input id="registBtn" value="登录" style="display:none" lay-submit
                                   style="width:100%;" type="button"
                                   lay-filter="registForm">
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var option = {
        onSuccess: function ()
        {
            if ($('#loginName').val() && $('#loginPass').val() && $('#userName').val() && $('#mobile').val())
            {
                $('#registBtn').click();
            }
            else
