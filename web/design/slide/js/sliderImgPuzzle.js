...
function getRandomImg(){return '/design/slide/randomImg/'+getRandomNumberByRange(0,5)+".jpeg"}
...
class sliderImgPuzzle{constructor({el,onSuccess,onFail,onRefresh}){this.el=el
